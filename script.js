...
async function handleRequest(event) {
  ...
  if (pathname === '/create') {
    ...
    if (request.method === 'POST') {
      ...
      const qrCodeUrl = track ? `https://qr.nips.gg/${randomString}` : dataInput
    ...
    if (key) {
      ...
      if (storedValue) {
        ...
        if (searchParams.has('stats')) {
          ...
          return Response.redirect(data.dataInput, 302)
        }
      } else {
      ...
      <head>
        ...
        <script>
          ...
          document.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById('dataInput').addEventListener('input', updateQRCode);
            document.getElementById('track').addEventListener('change', handleTrackChange);
          ...
          function handleTrackChange() {
            ...
            submitButton.disabled = !track;
            updateQRCode();
          }

          function updateQRCode() {
            const track = document.getElementById('track').checked;
            const dataInput = track ? "https://qr.nips.gg/${randomString}" : document.getElementById('dataInput').value;
      ...
      <body>
        <div class="container">
          ...
          <form method="POST" action="/create" enctype="multipart/form-data">
            ...
            <label for="track">Tracked/Proxied:</label>
